...
# Header/font/memory includes aren't captured by the pattern rule below,
# so list them explicitly to force a rebuild when they change.
main.o: main.asm gbhw.inc ibmpc1.inc memory.asm
